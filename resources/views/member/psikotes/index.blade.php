                                    ...
                                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                                        <div class="card card-body">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="date" class="form-control @error('tanggal') is-invalid @enderror" min="<?= date('Y-m-d', strtotime('+2 days')) ?>" name="tanggal" id="tanggal" placeholder="Pilih Tanggal" aria-label="Pilih Tanggal" aria-describedby="button-cek-jadwal">
